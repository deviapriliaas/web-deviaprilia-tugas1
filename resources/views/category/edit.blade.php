...
<head>
  ...
  <title>Create Data Category| Dashboard</title>
  ...
  <div class="content-wrapper">
    ...
    <table width="25%" border="0">
                        ...
                        <tr> 
                            ...
                            <td><input type="text" name="id_category" value="{{$categories->id_category}}"></td>
                        </tr>
                        <tr> 
                            <td>Nama Kategori</td>
                            <td><input type="text" name="name_category" value="{{$categories->name_category}}"></td>
                        </tr>
